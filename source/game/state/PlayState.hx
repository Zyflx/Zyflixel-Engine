...
class PlayState extends MusicBeatState
{
	...
	{
		for (i in scriptArray)
			i.callFunction('noteMiss', [direction]);
	...
	{
		for (i in scriptArray)
			i.callFunction('goodNoteHit', [notes.members.indexOf(note), note.noteData, note.isSustainNote]);
	...
	{
		for (i in scriptArray)
			i.callFunction('opponentNoteHit', [notes.members.indexOf(note), note.noteData, note.isSustainNote]);
